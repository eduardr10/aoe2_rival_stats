...
class IndexController extends Controller
{
    ...
    public function __invoke(Request $request, $player_id)
    {
        ...
        // Analizar al rival si existe, pero player_id en respuesta siempre es el de la URL
        $analyze_id = $rival_profile_id ? $rival_profile_id : $player_id;
        $request->merge([
    ...
    public function getPlayerStats($data_main_player)
    {
        ...
        // Ensure match_id is present in stats if available
